...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-QMUP5X75.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-DHSBSYS3.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-5AJ5B3ME.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-XFW6UYXN.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-GMC5X3BQ.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-52HH4C57.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-CAGNZPAF.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-K25N4IRG.js"));
    }
    if (features.pay) {
      featureImportPromises.push(import("./exports-XO6R7JCT.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-DUVIQX4T.js"),
      import("./w3m-modal-DDXGQY2N.js")
    ]);
  }
};

// node_modules/@reown/appkit/dist/esm/exports/constants.js
var PACKAGE_VERSION = "1.7.13";
...
//# sourceMappingURL=exports-BA7HGA2C.js.map
