...
export declare const ConstantsUtil: {
    ...
    readonly REMOTE_FEATURES_ALERTS: {
        readonly MULTI_WALLET_NOT_ENABLED: {
            readonly DEFAULT: {
                readonly shortMessage: "Multi-Wallet Not Enabled";
                readonly longMessage: "Multi-wallet support is not enabled. Please enable it in your AppKit configuration at cloud.reown.com.";
            };
            readonly CONNECTIONS_HOOK: {
                readonly shortMessage: "Multi-Wallet Not Enabled";
                readonly longMessage: "Multi-wallet support is not enabled. Please enable it in your AppKit configuration at cloud.reown.com to use the useAppKitConnections hook.";
            };
            readonly CONNECTION_HOOK: {
                readonly shortMessage: "Multi-Wallet Not Enabled";
                readonly longMessage: "Multi-wallet support is not enabled. Please enable it in your AppKit configuration at cloud.reown.com to use the useAppKitConnection hook.";
            };
        };
    };
};
