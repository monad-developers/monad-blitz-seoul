...
export class W3mModalBase extends LitElement {
    ...
    async onNewAddress(caipAddress) {
        ...
        const isNextAuthenticated = caipAddress && SIWXUtil.getSIWX()
            ? sessions.some(session => session.data.accountAddress === ParseUtil.parseCaipAddress(caipAddress)?.address)
            : true;
